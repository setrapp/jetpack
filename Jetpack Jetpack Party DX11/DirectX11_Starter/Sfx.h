...
public:
	...
	Sfx()
	{
		...
		g_waveBank = new WaveBank( p, L"D:\\New folder\\Jetpack Jetpack Party DX11\\Debug\\wavebank.xwb" );
		g_soundEffect =  new SoundEffect( p, L"D:\\New folder\\Jetpack Jetpack Party DX11\\Debug\\sunk.wav");
