...
void UDPClientConnectionEntity::sendMessage(string message){
	int echoStringLen= message.length();
	if (sendto(UDPClientConnectionEntity::sock, message.c_str(), echoStringLen, 0, (struct sockaddr *) 
